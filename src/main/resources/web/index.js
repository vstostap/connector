    ...
    getInitialState : function(){
        ...
        for(var i = 0 ; i < data.length; i++){
            ...
            for(var k = 0 ; k < data[i].page.length; k++){
                console.log(data[i].page[k].title);
        ...
        return {
            ...
            myStackedSeries : [
                {
                    values: _stackedValues['#3Dprinting'],
                    text: "#3Dprinting",
                    backgroundColor: "#076d7f"
                }, {
                    values: _stackedValues['#AR'],
                    text: "#AR",
                    backgroundColor: "#029fbc"
                }, {
                    values: _stackedValues['#iPhone'],
                    text: "#iPhone",
                    backgroundColor: "#00D9FF"
                }, {
                    values: _stackedValues['#Smartphone&'],
                    text: "#Smartphone&",
                    backgroundColor: "#bae2ff"
                },
                {
                    values: _stackedValues['#Handy'],
                    text: "#Handy",
                    backgroundColor: "#bae2ff"
                }
            ],
